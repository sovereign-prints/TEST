...
- **4D whale section:** a "tesseract" made of whales. Two wireframe southern right whales sit at either end of a fourth axis, joined across it the way a tesseract joins two cubes. The shape rotates through the fourth dimension and beats its tail live, with near lines drawn darker than far ones. Visitors can drag to spin it. It's plain SVG plus about 200 lines in `studio.js`, it pauses when off-screen, and it shows a still frame under reduced motion.
